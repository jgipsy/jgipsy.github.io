<?xml version="1.0" encoding="UTF-8"?><rss xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:atom="http://www.w3.org/2005/Atom" version="2.0"><channel><title><![CDATA[jgipsy]]></title><description><![CDATA[jgipsy]]></description><link>https://jgipsy.github.io</link><generator>RSS for Node</generator><lastBuildDate>Thu, 28 Sep 2017 06:57:12 GMT</lastBuildDate><atom:link href="https://jgipsy.github.io/feed.xml" rel="self" type="application/rss+xml"/><item><title><![CDATA[Ansible get started]]></title><description><![CDATA[<p>ansible -m raw -a 'sudo pkg install -y python2' -u &#x3C;<username>> &#x3C;<ip>>
sudo pkg install -y python27
sudo ln -s /usr/local/bin/python2.7 python
sudo ln -s /usr/local/bin/python2.7 /usr/bin/python
ansible-playbook &#x3C;&#x3C;playbook.yml>> -s -u &#x3C;<username>> --extra-vars "ansible_sudo_pass=&#x3C;<password>>"</p>
