...
var _webpackVersion = require("../_utils/webpack-version");

var _webpackVersion2 = _interopRequireDefault(_webpackVersion);
...
exports.default = function (config) {
  ...
  if (config.static && config.server) {
    ...
    var devConfig = _extends({}, webpackConfig, {
      ...
      plugins: [].concat(_toConsumableArray(webpackConfig.plugins || []), _toConsumableArray((0, _webpackVersion2.default)() === 2 ? [new _webpack2.default.optimize.OccurrenceOrderPlugin()] : [new _webpack2.default.optimize.OccurenceOrderPlugin()]), [new _webpack2.default.HotModuleReplacementPlugin()], _toConsumableArray((0, _webpackVersion2.default)() === 2 ? new _webpack2.default.NoEmitOnErrorsPlugin() : new _webpack2.default.NoErrorsPlugin()))
    });
