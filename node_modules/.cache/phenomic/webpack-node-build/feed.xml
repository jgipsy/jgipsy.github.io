<?xml version="1.0" encoding="UTF-8"?><rss xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:atom="http://www.w3.org/2005/Atom" version="2.0"><channel><title><![CDATA[jgipsy]]></title><description><![CDATA[jgipsy]]></description><link>https://jgipsy.github.io</link><generator>RSS for Node</generator><lastBuildDate>Tue, 14 Mar 2017 15:23:16 GMT</lastBuildDate><atom:link href="https://jgipsy.github.io/feed.xml" rel="self" type="application/rss+xml"/><item><title><![CDATA[Redis high availavility installation]]></title><description><![CDATA[<h1 id="install-redis-in-a-host-app_server_1_ip"><a href="#install-redis-in-a-host-app_server_1_ip" class="phenomic-HeadingAnchor">#</a>Install redis in a host &#x3C;APP_SERVER_1_IP></h1>
...
sentinel<span class="hljs-built_in"> monitor </span>bonpreu &#x3C;APP_SERVER_1_IP> 6379 2  
...
<pre><code class="hljs language-shell">bind &#x3C;APP_SERVER_2_IP>
sentinel<span class="hljs-built_in"> monitor </span>bonpreu &#x3C;APP_SERVER_2_IP> 6379 2  
sentinel down-after-milliseconds bonpreu 6000</code></pre>
...
sentinel<span class="hljs-built_in"> monitor </span>bonpreu &#x3C;APP_SERVER_3_IP> 6379 2</code></pre>
